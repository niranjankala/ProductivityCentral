...
namespace ProductivityCentral.Logging {
    [Serializable]
    public class ProductivityCentralSerilogLogger : MarshalByRefObject, Logger {
        private static readonly Type declaringType = typeof(ProductivityCentralSerilogLogger);       

        public ProductivityCentralSerilogLogger(Serilog.ILogger logger, ProductivityCentralSerilogFactory factory) {
        ...
        internal ProductivityCentralSerilogLogger() {
        }
        ...
        protected internal ProductivityCentralSerilogFactory Factory { get; set; }
