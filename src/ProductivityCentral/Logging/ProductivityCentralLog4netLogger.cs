...
namespace ProductivityCentral.Logging {
    [Serializable]
    public class ProductivityCentralLog4netLogger : MarshalByRefObject, Logger {
        private static readonly Type declaringType = typeof(ProductivityCentralLog4netLogger);       

        public ProductivityCentralLog4netLogger(log4net.Core.ILogger logger, ProductivityCentralLog4netFactory factory) {           
            Logger = logger;
            Factory = factory;
        }

        internal ProductivityCentralLog4netLogger() {
        }

        internal ProductivityCentralLog4netLogger(ILog log, ProductivityCentralLog4netFactory factory)
        ...
        protected internal ProductivityCentralLog4netFactory Factory { get; set; }
