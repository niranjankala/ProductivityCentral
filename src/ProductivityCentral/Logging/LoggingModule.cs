...
namespace ProductivityCentral.Logging
{
    ...
    public class LoggingModule : Module
    {
        ...
        {
            // by default, use ProductivityCentral's logger that delegates to Castle's logger factory
            ...
            {
                moduleBuilder.RegisterType<ProductivityCentralLog4netFactory>().As<Castle.Core.Logging.ILoggerFactory>().InstancePerLifetimeScope();
            }
            else
            {
                moduleBuilder.RegisterType<ProductivityCentralSerilogFactory>().As<Castle.Core.Logging.ILoggerFactory>().InstancePerLifetimeScope();
            }
